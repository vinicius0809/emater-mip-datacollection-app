				...
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addModal" class="btn btn-success" data-toggle="modal">
							...
							<span>Criar Nova Macrorregião</span>
						</a>
					</div>
				</div>
			</div>
				...
				<tbody>
					<#list macroregions as macroregion>
						<tr>
							...
							<td>
								<a href="#editModal" class="edit" data-toggle="modal" data-id="${macroregion.id}" data-name="${macroregion.name}">
									<i class="material-icons" data-toggle="tooltip" title="Alterar">&#xE254;</i>
								</a>
								<a href="#deleteModal" class="delete" data-toggle="modal" data-id="${macroregion.id}" data-name="${macroregion.name}">
