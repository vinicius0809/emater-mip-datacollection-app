				...
				<tbody>
					<#list farmers as farmer>
						<tr>
							...
							<td>${farmer.name}</td>
							<td>
								<a href="#editModal" class="edit" data-toggle="modal" data-id="${farmer.id}" data-name="${farmer.name}">
									<i class="material-icons" data-toggle="tooltip" title="Alterar">&#xE254;</i>
								</a>
								<a href="#deleteModal" class="delete" data-toggle="modal" data-id="${farmer.id}" data-name="${farmer.name}">
