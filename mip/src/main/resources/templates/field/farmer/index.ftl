...
<head>
    ...
    <title><@spring.message "page.title.farmer" /></title>
    ...
    <#include "/menubar.ftl">
        ...
        <form action="#" method="post" class="card" style="margin: 15px">
            <div class="card-header text-white" style="background-color: #004900">
                <h2 class="card-title" style="display: inline"><@spring.message "card.title.farmer"/></h2>

                <a href="#addModal" class="btn btn-success float-right" data-toggle="modal">
                    <i class="material-icons align-middle">&#xE147;</i>
                    <span class="align-middle"><@spring.message "card.button.new.farmer"/></span>
                </a>
            </div>
                        ...
                        <#list farmers as farmer>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#editModal" class="text-warning" data-toggle="modal" data-id="${farmer.id}" data-name="${farmer.name}">
                                        <i class="material-icons" data-toggle="tooltip" title="${updateLabel}">&#xE254;</i>
                                    </a>
                                    <a href="#deleteModal" class="text-danger" data-toggle="modal" data-id="${farmer.id}" data-name="${farmer.name}">
