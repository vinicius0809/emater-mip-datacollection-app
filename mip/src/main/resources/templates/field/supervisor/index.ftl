				...
				<tbody>
					<#list supervisors as supervisor>
						<tr>
							...
							<td>
								<a href="#editModal" class="edit" data-toggle="modal" data-id="${supervisor.id}" data-name="${supervisor.name}">
									<i class="material-icons" data-toggle="tooltip" title="Alterar">&#xE254;</i>
								</a>
								<a href="#deleteModal" class="delete" data-toggle="modal" data-id="${supervisor.id}" data-name="${supervisor.name}">
