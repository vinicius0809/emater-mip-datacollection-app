...
<head>
    ...
    <title><@spring.message "page.pest.pest" /></title>
    ...
    <div class="container-fluid">
        ...
        <form action="#" method="post" class="card" style="margin: 15px">
            <div class="card-header text-white" style="background-color: #004900">
                <h2 class="card-title" style="display: inline"><@spring.message "card.title.pest" /></h2>

                <a href="#addModal" class="btn btn-success float-right" data-toggle="modal">
                    <i class="material-icons align-middle">&#xE147;</i>
                    <span class="align-middle"><@spring.message "card.button.new.pest" /></span>
                </a>
            </div>
                ...
                <table id="mainTable" class="table table-striped table-hover">
                    <thead style="background-color: #004900; color: white">
                        <tr>
                            ...
                            <th class="col-sm-4"><@spring.message "table.list.scientific-name" /></th>
                            <th class="col-sm-2"><@spring.message "table.list.size" /></th>
