...
<head>
    ...
    <title><@spring.message "page.title.field" /></title>
    ...
    <#include "/menubar.ftl">
        ...
        <form action="#" method="post" class="card" style="margin: 15px">
            <div class="card-header text-white" style="background-color: #004900">
                <h2 class="card-title" style="display: inline"><@spring.message "card.title.field" /></h2>

                <a href="#addModal" class="btn btn-success float-right" data-toggle="modal">
                    <i class="material-icons align-middle">&#xE147;</i>
                    <span class="align-middle"><@spring.message "card.button.new.field"  /></span>
                </a>
            </div>
            ...
            <div class="card-body table-responsive-md">
                ...
                <table id="mainTable" class="table table-striped table-hover">
                    <thead style="background-color: #004900; color: white">
                        <tr>
                            <th class="col-sm-2"><@spring.message "table.list.identification" /></th>
                            <th class="col-sm-2"><@spring.message "table.list.location" /></th>
                        ...
                        <#list fields as field>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#editModal" class="text-warning" data-toggle="modal" data-id="${field.id}" data-name="${field.name}" data-location="${field.location}" data-city="${field.city.id}" data-farmer="${field.farmer.id}">
                                        <i class="material-icons" data-toggle="tooltip" title="${updateLabel}">&#xE254;</i>
                                    </a>
                                    <a href="#deleteModal" class="text-danger" data-toggle="modal" data-id="${field.id}" data-name="${field.name}">
